...
export function AuthProvider({ children }) {
	useEffect(() => {
		if (import.meta.env.VITE_API_PROVIDER === 'oidc') {
	...
	async function OidcSignin() {
		...
		const auth_url = `${import.meta.env.VITE_API_AUTH_URL}?response_type=code&client_id=${
		...
		try {
			...
			const response = await axios.post(
				import.meta.env.VITE_API_TOKEN_URL,
				{
					...
					code: code,
					redirect_uri: import.meta.env.VITE_API_REDIRECT_URL,
			...
			const url = `${import.meta.env.VITE_API_BASE_URL}/users/oidc`;
			await axios.post(
				url,
				{},
				{
...
export function Signout() {
	...
	window.location.href = import.meta.env.PUBLIC_URL;
}
...
export async function GetToken() {
	...
	if (
		...
		import.meta.env.VITE_API_PROVIDER === 'oidc'
	) {

...
export const fetchLicenses = async ({
	...
	const base_url = `${import.meta.env.VITE_API_BASE_URL}/licenses?page=${page}&limit=${limit}&sort_by=${sortField}&order_by=${sortOrder}`;
...
export const fetchLicensePreviews = async () => {
	const url = `${import.meta.env.VITE_API_BASE_URL}/licenses/preview?active=true`;
	const headers = {};
...
export const fetchObligations = async ({
	...
	const base_url = `${import.meta.env.VITE_API_BASE_URL}/obligations?page=${page}&limit=${limit}&order_by=${sortOrder}`;
	const paramString = Object.entries(params)
		.map(
			([key, value]) =>
				`${encodeURIComponent(key)}=${encodeURIComponent(value)}`,
...
export const fetchUsers = async ({
	...
	const base_url = `${import.meta.env.VITE_API_BASE_URL}/users?active=true&page=${page}&limit=${limit}`;
	const paramString = Object.entries(params)
		.map(
			([key, value]) =>
				`${encodeURIComponent(key)}=${encodeURIComponent(value)}`,
...
export const fetchAudits = async ({ page, limit, params = {} }) => {
	const base_url = `${import.meta.env.VITE_API_BASE_URL}/audits?page=${page}&limit=${limit}`;
	const paramString = Object.entries(params)
		.map(
			([key, value]) =>
				`${encodeURIComponent(key)}=${encodeURIComponent(value)}`,
...
export const fetchAuditDetails = async ({ auditId }) => {
	const base_url = `${import.meta.env.VITE_API_BASE_URL}/audits/${auditId}/changes`;
	const headers = {};
...
export const postLicense = async ({ licensePayload }) => {
	const url = `${import.meta.env.VITE_API_BASE_URL}/licenses`;
	const headers = {};
...
export const postObligation = async ({ obligationPayload }) => {
	const url = `${import.meta.env.VITE_API_BASE_URL}/obligations`;
	const headers = {};
...
export const updateLicense = async ({
	...
	const url = `${import.meta.env.VITE_API_BASE_URL}/licenses/${encodeURIComponent(shortname)}`;
	const headers = {};
...
export const updateObligation = async ({
	...
	const url = `${import.meta.env.VITE_API_BASE_URL}/obligations/${encodeURIComponent(topic)}`;
	const headers = {};
...
export const updateObligationWithLicenses = async ({
	...
	const url = `${import.meta.env.VITE_API_BASE_URL}/obligation_maps/topic/${encodeURIComponent(topic)}/license`;
	const headers = {};
...
export const updateUser = async ({ userPayload, username }) => {
	const url = `${import.meta.env.VITE_API_BASE_URL}/users/${encodeURIComponent(username)}`;
	const headers = {};
...
export const exportLicenses = async () => {
	const url = `${import.meta.env.VITE_API_BASE_URL}/licenses/export`;
	const headers = {};
...
export const exportObligations = async () => {
	const url = `${import.meta.env.VITE_API_BASE_URL}/obligations/export`;
	const headers = {};
...
export const uploadLicenseFile = async file => {
	...
	const url = `${import.meta.env.VITE_API_BASE_URL}/licenses/import`;
	const headers = {};
...
export const uploadObligationFile = async file => {
	const formData = new FormData();
	formData.append('file', file);
	const url = `${import.meta.env.VITE_API_BASE_URL}/obligations/import`;
	const headers = {};
...
export const fetchObligationPreviews = async () => {
	const url = `${import.meta.env.VITE_API_BASE_URL}/obligations/preview?active=true`;
	const headers = {};
...
export const fetchObligationsOfLicense = async ({ shortname }) => {
	const url = `${import.meta.env.VITE_API_BASE_URL}/obligation_maps/license/${encodeURIComponent(shortname)}`;
	const headers = {};
...
export const updateObligationsOfLicense = async ({
	...
	const obligationUpdatePromises = Object.keys(changes).map(topic =>
		axios.patch(
			`${import.meta.env.VITE_API_BASE_URL}/obligation_maps/topic/${encodeURIComponent(topic)}/license`,
			{ map: changes[topic] },
			{
				headers,
			},
...
export const fetchObligationTypes = async () => {
	const url = `${import.meta.env.VITE_API_BASE_URL}/obligations/types`;
	const headers = {};
...
export const deleteObligationType = async ({ type }) => {
	const url = `${import.meta.env.VITE_API_BASE_URL}/obligations/types/${encodeURIComponent(type)}`;
	const headers = {};
...
export const fetchObligationClassfications = async () => {
	const url = `${import.meta.env.VITE_API_BASE_URL}/obligations/classifications`;
	const headers = {};
...
export const deleteObligationClassification = async ({ classification }) => {
	const url = `${import.meta.env.VITE_API_BASE_URL}/obligations/classifications/${encodeURIComponent(classification)}`;
	const headers = {};
	if (
		isApiAuthenticated(
...
export const fetchUserProfile = async token => {
	const url = `${import.meta.env.VITE_API_BASE_URL}/users/profile`;
	const headers = {};
...
export const fetchDashboardData = async () => {
	const url = `${import.meta.env.VITE_API_BASE_URL}/dashboard`;
	const headers = {};
...
export const fetchApiAuthSettings = async () => {
	const url = `${import.meta.env.VITE_API_BASE_URL}/apiCollection`;
	const response = await axios.get(url);
	return response.data;
};
